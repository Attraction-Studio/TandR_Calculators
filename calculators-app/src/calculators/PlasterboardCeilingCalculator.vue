        ...
        <div v-if="currentStep === 1">
          <div class="border border-brand-black p-6 bg-white sticky top-4">
            ...
            <ul class="space-y-3 text-sm">
              ...
              <li class="flex items-start">
                <span class="mr-2">•</span>
                <span>Luminaire Weight and Spacing</span>
              </li>
              <li class="flex items-start">
                <span class="mr-2">•</span>
            ...
            <p class="mt-4 text-sm text-gray-600">
              This design is for T&R Suspended Plasterboard Grid System only and
              cannot be used with other manufacturer's ceiling products.
            </p>
          </div>
            ...
            <div class="border-t border-gray-300 pt-4">
              ...
              <div class="text-lg">
                <span
                  >SLS =
                  {{
                    state.maxAllowableTeeLengths.value.main.sls > 0
                ...
                <span v-if="state.limitStateLogic.showSLS2Calculations.value">
                  SLS2 =
                  {{
                    state.maxAllowableTeeLengths.value.main.sls2 > 0
                ...
                <span
                  >ULS =
                  {{
                    state.maxAllowableTeeLengths.value.main.uls > 0
            ...
            <div class="border-t border-gray-300 pt-4">
              ...
              <div class="text-lg">
                <span
                  >SLS =
                  {{
                    state.maxAllowableTeeLengths.value.cross.sls > 0
                ...
                <span v-if="state.limitStateLogic.showSLS2Calculations.value">
                  SLS2 =
                  {{
                    state.maxAllowableTeeLengths.value.cross.sls2 > 0
                ...
                <span
                  >ULS =
                  {{
                    state.maxAllowableTeeLengths.value.cross.uls > 0
...
<script setup>
  ...
  import { useCalculatorState } from "./PlasterboardCeilingCalculator/composables/useCalculatorState.js";

  // Step components
  import IntroductionStep from "./PlasterboardCeilingCalculator/steps/IntroductionStep.vue";
  import LimitStateStep from "./PlasterboardCeilingCalculator/steps/LimitStateStep.vue";
  import SeismicWeightStep from "./PlasterboardCeilingCalculator/steps/SeismicWeightStep.vue";
  import SeismicActionsStep from "./PlasterboardCeilingCalculator/steps/SeismicActionsStep.vue";
  import CeilingCapacityStep from "./PlasterboardCeilingCalculator/steps/CeilingCapacityStep.vue";
  import BackBraceStep from "./PlasterboardCeilingCalculator/steps/BackBraceStep.vue";
  import BackBraceLayoutStep from "./PlasterboardCeilingCalculator/steps/BackBraceLayoutStep.vue";
  import SeismicClearanceStep from "./PlasterboardCeilingCalculator/steps/SeismicClearanceStep.vue";
  import DownloadStep from "./PlasterboardCeilingCalculator/steps/DownloadStep.vue";
  ...
  const wizardSteps = computed(() => {
    ...
    if (state.showBackBrace.value) {
      steps.push({ number: 6, label: "Back Brace" });
  ...
  // Watch for back brace activation
  watch(
    () => state.showBackBrace.value,
    (val) => {
      if (val && currentStep.value === 5) {
        currentStep.value = 6;
        scrollToTop();
      }
    },
