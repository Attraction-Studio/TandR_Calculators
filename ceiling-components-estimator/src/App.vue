<template>
  <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
    <h2 class="text-2xl font-bold mb-6 text-gray-800">Ceiling Components Estimator</h2>
    ...
    <div class="mb-6 space-y-4">
      ...
      <button
        @click="calculate"
        class="w-full md:w-auto px-6 py-3 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 transition-colors"
      >
        Calculate
      </button>
    </div>
    ...
    <!-- Results Section -->
    <div v-if="showResults" class="mt-8 space-y-4">
      <div class="border-t pt-6">
        ...
        <div class="mb-4 p-4 bg-gray-50 rounded-md">
          ...
          <p class="text-2xl font-bold text-gray-800">{{ area.toFixed(2) }} m²</p>
        </div>
        ...
        <div class="overflow-x-auto">
          <table class="w-full border-collapse">
            ...
            <tbody>
              <tr>
                <td class="border border-gray-300 px-4 py-2 font-medium">{{ tileTypeText }}</td>
                <td class="border border-gray-300 px-4 py-2 text-right">{{ adjustedR2 }}</td>
              </tr>
              <tr>
                <td class="border border-gray-300 px-4 py-2">Component 1</td>
                <td class="border border-gray-300 px-4 py-2 text-right">{{ adjustedR3 }}</td>
              </tr>
              <tr>
                <td class="border border-gray-300 px-4 py-2">Component 2</td>
                <td class="border border-gray-300 px-4 py-2 text-right">{{ adjustedR4 }}</td>
              </tr>
              <tr>
                <td class="border border-gray-300 px-4 py-2">Component 3</td>
                <td class="border border-gray-300 px-4 py-2 text-right">{{ adjustedR6 }}</td>
              </tr>
              <tr>
                <td class="border border-gray-300 px-4 py-2">Component 4</td>
                <td class="border border-gray-300 px-4 py-2 text-right">{{ adjustedR7 }}</td>
              </tr>
              <tr v-if="tileSize === '2'">
                <td class="border border-gray-300 px-4 py-2">Component 4a</td>
                <td class="border border-gray-300 px-4 py-2 text-right">{{ adjustedR7a }}</td>
              </tr>
              <tr>
                <td class="border border-gray-300 px-4 py-2">Component 5</td>
                <td class="border border-gray-300 px-4 py-2 text-right">{{ adjustedR8 }}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
const adjustedR2 = computed(() => {
  return Math.round((baseValues.value.r2 / 100) * variance.value + baseValues.value.r2)
})

const adjustedR3 = computed(() => {
  return Math.round((baseValues.value.r3 / 100) * variance.value + baseValues.value.r3)
})

const adjustedR4 = computed(() => {
  return Math.round((baseValues.value.r4 / 100) * variance.value + baseValues.value.r4)
})

const adjustedR6 = computed(() => {
  return Math.round((baseValues.value.r6 / 100) * variance.value + baseValues.value.r6)
})

const adjustedR7 = computed(() => {
  return Math.round((baseValues.value.r7 / 100) * variance.value + baseValues.value.r7)
})

const adjustedR7a = computed(() => {
  return Math.round((baseValues.value.r7a / 100) * variance.value + baseValues.value.r7a)
})

const adjustedR8 = computed(() => {
  return Math.round((baseValues.value.r8 / 100) * variance.value + baseValues.value.r8)
})
